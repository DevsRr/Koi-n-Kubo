                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative aspect-square overflow-hidden">
                      ...
                      {/* SOLD OUT banner — top right ribbon */}
                      {isSoldOut && (
                        <div className="absolute top-4 right-0">
                          <div className="bg-red-600 text-white text-xs font-bold px-4 py-1 shadow-md tracking-widest uppercase">
                            Sold Out
                          </div>
                        </div>
                      )}
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className={`text-xs font-medium ${
                          ...
                          {isSoldOut ? 'Sold Out' : isLowStock ? `Only ${item.stock} left` : 'In Stock'}
                        </span>
                      </div>
                      ...
                      {!isSoldOut ? (
                        ...
                        <Button disabled className="w-full bg-red-100 text-red-400 cursor-not-allowed border border-red-200">
                          Sold Out
                        </Button>
                      )}
                    </div>
